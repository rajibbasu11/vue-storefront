import { CustomQuery, ProductSearchParams, UseProduct } from '../types';
...
export type UseProductFactoryParams<PRODUCT, PRODUCT_SEARCH_PARAMS extends ProductSearchParams> = {
